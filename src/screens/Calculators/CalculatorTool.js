...
const createStyles = (colors, isLight) => StyleSheet.create({
  ...
  bannerGhost: { borderRadius: 999, borderWidth: 1, borderColor: 'rgba(255,255,255,0.7)', paddingHorizontal: 12, paddingVertical: 7 },
  bannerGhostText: { color: '#ffffff', fontSize: 12, fontFamily: FONT.semiBold },
